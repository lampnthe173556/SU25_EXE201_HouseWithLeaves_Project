...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B3F95048E");
        ...
        {
            entity.HasKey(e => e.CouponId).HasName("PK__Coupons__384AF1DAFABF6435");

            entity.HasIndex(e => e.Code, "UQ__Coupons__A25C5AA7A6814E7A").IsUnique();
        ...
        {
            entity.HasKey(e => e.FavoriteId).HasName("PK__Favorite__CE74FAF5EFBE02F0");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF29F0420A");
            ...
            entity.HasOne(d => d.PaymentMethod).WithMany(p => p.Orders)
                ...
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK__Orders__PaymentM__46E78A0C");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30CDF060759");
        ...
        {
            entity.HasKey(e => e.PaymentMethodId).HasName("PK__PaymentM__DC31C1F35D943C05");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6EDAE40461B");
        ...
        {
            entity.HasKey(e => e.ImageId).HasName("PK__ProductI__7516F4EC6DDE11CC");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3A73934667");

            entity.HasIndex(e => e.RoleName, "UQ__Roles__8A2B6160213C4DA5").IsUnique();
        ...
        {
            entity.HasKey(e => e.ShippingMethodId).HasName("PK__Shipping__0C783384951B48F2");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC0656F96A");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105348D753E97").IsUnique();

            entity.HasIndex(e => e.UserName, "UQ__Users__C9F284560D014059").IsUnique();
